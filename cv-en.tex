...
\cventry{2024--present}{Full-time Researcher and Lead Developer}{Jij, Inc.}{Tokyo, Japan}{}{%
  Desigining Devlopping JijModeling 2, the next-generation mathematical optimization modeller embedded in Python and written in Rust.\newline%
  %
  Main achievements:%
  \begin{itemize}
    \item Led the complete redesign and implementation of JijModeling version 2 from scratch, including:
      \begin{itemize}
        \item Achieved loose coupling with the surface language (Python)
        \item Enhanced constraint detection mechanisms through symbolic processing
        \item Designed and implemented language features
        \item Designed and implemented a dedicated type system
      \end{itemize}
    \item Presented related academic and technical findings at domestic and international conferences
  \end{itemize}
}
\cventry{2019--Oct 2024}{Full-time Researcher and Developer}{DeepFlow, Inc.}{Tokyo, Japan}{}{%
...
\cvitemwithcomment{Rust}{Advanced}{Designed and implemented a commercial programming language from scratch in Rust.}
...
Especially, I have expertise in designing statically/dependently-typed EDSLs in Haskell, Rust, and Python for scientific and/or mathematical computations.
...
\begin{itemize}
  ...
  \item Linear Types / Ownership System: mainly used for array allocation and pure mutation.
  \item FFI: having been using to implement binding libraries. Both via GHC's FFI functionality and/or \texttt{inline-c}.
  \item Type System Design: designed and implemented custom type systems for domain-specific languages.
\end{itemize}
...
\subsection{Recent Peer-Reviewed Papers}

\noindent
June 2025, \emph{Optimizing Optimizations: Case Study on Detecting Specific Types of Mathematical Optimization Constraints with E-Graphs in JijModeling}. EGRAPHS '25 (colocated with PLDI '25), Seoul, South Korea. (Joint work with T. Shimizu and T. Teramura)

\noindent
May 2025, \emph{Introduction to JijModeling, a Mathematical Optimization Modelling Tool}. JSAI 2025 (The 39th Annual Conference of the Japanese Society for Artificial Intelligence), Osaka, Japan. (Joint work with T. Shimizu and T. Teramura)

\subsection{Commercial Technical Articles}

\noindent
December 2025, \emph{Understanding Monads and Friends via do-notation}. Published in ``n-Monthly Lambda Note'' Vol.5 No.2 (2025). Lambda Note, Inc.

\subsection{Technical Conferences}

\noindent
June 2025, \emph{Two Monads in the World of Rust --- Writing Programs Intuitively with do-notation in Rust}. Kansuu-gata Matsuri (Functional Fest), Tokyo, Japan.
